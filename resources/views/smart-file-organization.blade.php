...
@section('description', 'Organize your shared files with custom folders and smart categorization. Create, manage, and
    search through your files efficiently with AirToShare.')
@section('keywords', 'file organization, custom folders, file management, smart categorization, file search,
    AirToShare')
    ...
    <div class="smart-org-container">
        ...
        <div class="smart-org-header">
            ...
            <p class="smart-org-subtitle">
                Create custom folders, organize your attachments, and find files instantly with our intelligent file
                management system.
            </p>
        </div>
            ...
            <div class="control-section">
                ...
                <div class="folder-creation">
                    <input type="text" class="folder-input"
                        placeholder="Enter folder name (e.g., Documents, Images, Projects)" maxlength="50">
                ...
                <div class="files-grid">
                    ...
                    <div class="file-item">
                        ...
                        <div class="file-preview">
                            <img src="https://images.pexels.com/photos/1181671/pexels-photo-1181671.jpeg?auto=compress&cs=tinysrgb&w=200"
                                alt="Vacation photo preview">
                        </div>
                    ...
                    <div class="file-item">
                        <input type="checkbox" class="file-checkbox">
                        <div class="file-preview">
                            <img src="https://images.pexels.com/photos/1181677/pexels-photo-1181677.jpeg?auto=compress&cs=tinysrgb&w=200"
                    ...
                    <div class="file-item">
                        <input type="checkbox" class="file-checkbox">
                        <div class="file-preview">
                            <img src="https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&w=200"
                    ...
                    <div class="file-item">
                        <input type="checkbox" class="file-checkbox">
                        <div class="file-preview">
                            <img src="https://images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg?auto=compress&cs=tinysrgb&w=200"
